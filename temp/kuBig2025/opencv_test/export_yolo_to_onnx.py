...
import yaml
from models.common import Contract, Conv
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--cfg", type=str, default="models/yolov5s.yaml", help="yaml file path"
    )
    parser.add_argument(
        "--weights", type=str, default="weights/yolov5s-face.pt", help="model.pt path"
    )
    parser.add_argument(
        "--image", type=str, default="data/images/test.jpg", help="source"
    )  # file/folder, 0 for webcam
    parser.add_argument(
        "--imgsize", type=int, default=640, help="inference size (pixels)"
    )

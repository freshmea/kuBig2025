...
- 수업 목표
  - OpenCV의 기본 개념을 이해하고 이미지 처리 및 컴퓨터 비전의 기초를 익힌다.
  - camera와 이미지 파일을 이용한 이미지 처리 방법을 익힌다.
...
- 수업 목표
- 딥러닝의 기본 개념을 이해하고, 다양한 딥러닝 알고리즘을 익힌다.
- 딥러닝을 이용한 데이터 분석 및 예측 방법을 익힌다.
- 프로젝트에 서 딥러닝을 적용하여 실제 문제를 해결하는 방법을 익힌다.
- [과정 진행 사항](doc/dl.md)
- 참고:---
